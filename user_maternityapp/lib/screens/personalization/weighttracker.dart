  ...
  Future<void> deleteWeightRecord(int recordId) async {
    ...
    try {
      await supabase
          .from('tbl_weighttracker')
          .delete()
          .eq('id', recordId); // Corrected to 'id'
      ...
      setState(() {
        isLoading = false;
        errorMessage = "Couldn't delete weight record. Please try again.";
      });
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to delete weight record'),
                          ...
                          : SliverList(
                              delegate: SliverChildBuilderDelegate(
                                (context, index) {
                                  ...
                                  final weight = record['weighttracker_weight']; // Corrected
                                            ...
                                            children: [
                                              ...
                                              IconButton(
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  if (confirm == true) {
                                                    await deleteWeightRecord(record['id']); // Corrected to 'id'
                                                  }
                                                },
                                              ),
                                            ],
